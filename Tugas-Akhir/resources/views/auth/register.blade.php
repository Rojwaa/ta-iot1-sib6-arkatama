        ...
        <div class="row no-gutters">
            <div class="col-sm-6 align-self-center">
                <div class="sign-in-from">
                    ...
                    @include('layouts.dasboard.alerts.danger-alert')
            ...
            <div class="col-sm-6 text-center">
                    <div class="sign-in-detail text-white"
                        ...
                        <a class="sign-in-logo mb-5" href="#"><img class="img-fluid"></a>
                        <div data-items-mobile="1"
                            data-items-mobile-sm="1" data-margin="0">
                            <div class="item">
                                <img src="images/logo-3.jpeg" class="img-fluid mb-4" alt="logo">
                                <h4></h4>
                                <p>
                                </p>
                                <p>
